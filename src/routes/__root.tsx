...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SAT Hub" },
      { name: "description", content: "Simplified SAT prep and a peer community for global scholars." },
      { property: "og:title", content: "SAT Hub" },
      { name: "twitter:title", content: "SAT Hub" },
      { property: "og:description", content: "Simplified SAT prep and a peer community for global scholars." },
      { name: "twitter:description", content: "Simplified SAT prep and a peer community for global scholars." },
